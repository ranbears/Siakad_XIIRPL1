...
import 'package:flutter_industri/app/modules/loginn/controllers/loginn_controller.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/icon/smk-min.jpg"),
            fit: BoxFit.cover,
    ...
    return Center(
      child: ConstrainedBox(
        ...
        child: FittedBox(
          fit: BoxFit.contain,
          child: Image(
            image: AssetImage("assets/icon/logo(1).png"),
          ),
        ),
      ),
    );
